...
@register.name_to_model.register("Inception3")
class Inception3(nn.Module):

    def __init__(self, num_classes=1000, aux_logits=True, inception_blocks=None, init_weights=None, dropout=0.5, mode="train"):
        super().__init__()
