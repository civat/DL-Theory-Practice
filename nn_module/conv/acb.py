# The code is modified from https://github.com/DingXiaoH/ACNet/blob/master/acnet/acb.py
    ...
    def __init__(self, in_channels, out_channels, kernel_size, stride=1, padding=0, dilation=1, groups=1,
        ...
        if deploy:
            ...
            if padding - kernel_size // 2 >= 0:
                ...
                self.crop = 0
                #  Compared to the KxK layer, the padding of the 1xK layer and Kx1 layer should be
                #  adjust to align the sliding windows (Fig 2 in the paper)
